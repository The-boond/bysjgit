                ...
                <div class="Details_1">
                    <div class="product">
                        ...
                        <div class="product-infos">
                            ...
                            <h4 style="color: red;" v-if="detailsInfo?.price">¥ {{ detailsInfo?.price }}</h4>
                            <div class="rev-share">
                                ...
                                <a-row :gutter="[8,8]">  
                                            ...
                                            <a-col :span="8">
                                                <p class="content-contentChunk-item" >
                                                    <span class="item-key">员工名称:</span>
                                                    <span class="item-value">{{ detailsInfo?.employeename }}</span>
                                                </p>
                                            </a-col>
                                            
                                            <a-col :span="8">
                                                <p class="content-contentChunk-item" >
                                                    <span class="item-key">月份:</span>
                                                    <span class="item-value">{{ detailsInfo?.monthes }}</span>
                                                </p>
                                            </a-col>
                                            
                                            <a-col :span="8">
                                                <p class="content-contentChunk-item" >
                                                    <span class="item-key">薪资:</span>
                                                    <span class="item-value">{{ detailsInfo?.salary }}</span>
                                                </p>
                                            </a-col>
                                            
                                            <a-col :span="8">
                                                <p class="content-contentChunk-item" >
                                                    <span class="item-key">五险:</span>
                                                    <span class="item-value">{{ detailsInfo?.fiveinsurances }}</span>
                                                </p>
                                            </a-col>
                                            
                                            <a-col :span="8">
                                                <p class="content-contentChunk-item" >
                                                    <span class="item-key">一金:</span>
                                                    <span class="item-value">{{ detailsInfo?.onegold }}</span>
                                                </p>
                                            </a-col>
                                            ...
                                            <a-col :span="24">
                                                <p class="content-contentChunk-item" >
                                                    ...
                                                    <span class="item-value">{{ detailsInfo?.remarks }}</span>
                                                </p>
                                            </a-col>
            ...
            const GetDetails = async () => {
                const { code ,data} = await POST('/salariess/info', { id: history.state.id });
                if (code != '0') return;
