                ...
                <div class="product-content">
                  ...
                  <div class="product-label product-label-list">
                    ...
                    <div class="product-link">
                      <a-button type="primary" @click="GoDetails(i)"
                        >查看</a-button
                      >
                    </div>
                  </div>
...
const search = ref(
  history.state?.searchVal != undefined ? history.state.searchVal : ""
);
...
const GetContent = async () => {
  const { code, data } = await POST("/officesupplies/list", {
    classify:
      activeKey.value >= 1 ? classifyList.value[activeKey.value] : undefined,
