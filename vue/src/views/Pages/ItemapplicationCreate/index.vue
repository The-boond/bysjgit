      ...
      <a-row :gutter="24">
        ...
        <a-col :span="24">
          <a-form-item label="审核" name="shenhe">
            <a-input
              v-model:value="formData.shenhe"
              placeholder="请输入审核"
              :disabled="oldFormData.shenhe"
            />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="24">
          <a-form-item label="使用说明" name="instructionsforuse">
            <a-textarea
              v-model:value="formData.instructionsforuse"
              placeholder="请输入使用说明"
              :auto-size="{ minRows: 10, maxRows: 10 }"
              :disabled="oldFormData.instructionsforuse"
            />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="24">
          <a-form-item label="归还时间" name="returntime">
            <a-date-picker
              ...
              :disabled="oldFormData.returntime"
            />
          </a-form-item>
        </a-col>
