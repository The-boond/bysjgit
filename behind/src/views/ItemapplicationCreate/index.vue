            ...
            <template>
                <div class="createTemplate">
                    <p class="title">{{ formData.id ? '修改' : '录入' }}用品申领</p><a-divider />
                ...
                <a-form 
                    ...
                    <a-row :gutter="24">
                            ...
                            <a-col :span="12">
                                <a-form-item label="用品封面"  name="photo">
                            ...
                            <a-col :span="12">
                                <a-form-item label="使用说明"  name="instructionsforuse">
                                    <a-textarea v-model:value="formData.instructionsforuse" placeholder="请输入使用说明"
                            ...
                            <a-col :span="12">
                                <a-form-item label="归还时间"  name="returntime">
                                    <a-date-picker
                                        v-model:value="formData.returntime" format="YYYY-MM-DD HH:mm:ss"
            ...
            const route = useRoute();
                ...
                const OnSubmit = async (values) => {
                    ...
                    const { code } = await POST(`/itemapplication/${id != undefined ? "update" : "save"}`, data);
