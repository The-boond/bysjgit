            ...
            <template>
                <div class="createTemplate">
                    <p class="title">{{ formData.id ? '修改' : '录入' }}工作计划</p><a-divider />
                    ...
                    <a-row :gutter="24">
                            ...
                            <a-col :span="12">
                                <a-form-item label="工作内容"  name="workcontent">
                                    <div style="border: 1px solid #ccc">
                                        ...
                                        <Editor style="height: 500px; overflow-y: hidden;" v-model="formData.workcontent"
                            ...
                            <a-col :span="12">
                                <a-form-item label="任务类型"  name="tasktype">
                                    <a-input v-model:value="formData.tasktype"
                                        placeholder="请输入任务类型"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="负责人名称"  name="nameofpersonincharge">
                                    <a-input v-model:value="formData.nameofpersonincharge"
                                ...
                                <a-col :span="12">
                                    <a-form-item label="优先级"  name="priority">
                                        <a-radio-group v-model:value="formData.priority" placeholder="请选择优先级">
                            ...
                            <a-col :span="12">
                                <a-form-item label="开始时间"  name="starttime">
                                    <a-date-picker
                                        v-model:value="formData.starttime" format="YYYY-MM-DD HH:mm:ss"
                            ...
                            <a-col :span="12">
                                <a-form-item label="计划时长"  name="planningduration">
                                    <a-input v-model:value="formData.planningduration"
                                        placeholder="请输入计划时长"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="完成进度"  name="completionprogress">
                                    <a-input v-model:value="formData.completionprogress"
                                        placeholder="请输入完成进度"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="工作封面"  name="jobcover">
                                    <a-upload v-model:file-list="formData.jobcover" name="file" list-type="picture-card"
                                        class="cover-uploader" :show-upload-list="false" action="/api/file/upload" :maxCount="1"
                                        @change="JobcoverUploadChange">
                                        <a-image v-if="jobcoverImageUrl" :src="jobcoverImageUrl" :preview="false" />
                                        <a-image v-else-if="formData.jobcover" :src="formData.jobcover[0].url" :preview="false" />
