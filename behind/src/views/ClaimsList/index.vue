      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.dataIndex === 'opera'">
          <a-space wrap>
            ...
            <a-button type="link" @click="ClaimsOpen(record)">审核</a-button>
          </a-space>
        </template>
      </template>
    ...
    >
      <a-form class="formMessage" layout="inline" :model="formMessage">
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-form-item label="报销人id" name="adduserid">
              <p v-html="formMessage.adduserid"></p>
            </a-form-item>
          </a-col>

          <a-col :span="12">
            <a-form-item label="报销人" name="addusername">
          ...
          <a-col :span="12">
            <a-form-item label="审核回复" name="shenhehuifu">
              <p v-html="formMessage.shenhehuifu"></p>
            </a-form-item>
          </a-col>

          <a-col :span="12">
            <a-form-item label="报销备注" name="remark">
              <p v-html="formMessage.remark"></p>
            </a-form-item>
          </a-col>
...
const MessageRow = async ({ id }) => {
  const { code, data } = await POST("/claims/info", { id });
  if (code != 0) return;
